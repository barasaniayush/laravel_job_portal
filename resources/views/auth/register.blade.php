       ...
       @if(Session::has('message'))
          ...
          <div class="col-md-12 col-lg-8 mb-5">
            ...
            <form method="POST" action="" class="p-5 bg-white">
                        ...
                        <input type="hidden" value="job_seeker" name="user_type">
                        <div class="form-group row">
                    
                            <div class="col-md-12">Job Seeker Name</div>

                            <div class="col-md-12">
                                <input id="name" type="text" placeholder="Job Seeker name" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name') }}" required autofocus>
                    ...
                    <div class="col-md-12">
                        <input id="dob" type="date" placeholder="date of birth" class="form-control{{ $errors->has('dob') ? ' is-invalid' : '' }}" name="name" value="{{ old('dob') }}" required autofocus>
