            ...
            <a href="{{route('jobs.show', [$job->id,$job->slug])}}" class="job-item d-block d-md-flex align-items-center  border-bottom fulltime">
              ...
              <div class="job-details h-100">
                <div class="p-3 align-self-center">
                  ...
                  <div class="mr-3"><span class="icon-home mr-1"></span> {{$job->company->name}}</div>
    ...
    <div class="container">
      <div class="row align-items-center justify-content-center">
        <div class="col-md-6 text-center" data-aos="fade">
          ...
          <p><a href="/register" class="btn btn-outline-warning py-3 px-4">Employer Register</a> <a href="{{route('employer.register')}}" class="btn btn-warning py-3 px-4">Job Seeker Register</a></p>
